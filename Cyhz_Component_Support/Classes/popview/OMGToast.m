...
- (id)initWithText:(NSString *)text_{
    if (self = [super init]) {
		...
		NSDictionary * attributesDic = @{NSFontAttributeName:[UIFont boldSystemFontOfSize:14]};
...
+ (void)showWithText:(NSString *)text_
    ...
    mToast = [[OMGToast alloc] initWithText:text_];
    [mToast setDuration:duration_];
    [mToast show];
}
